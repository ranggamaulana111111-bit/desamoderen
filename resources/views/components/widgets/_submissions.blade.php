<div class="widget-card overflow-hidden">
    <div class="widget-card-header">
        <div class="flex items-center gap-2.5">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400">{{ !empty($latestSubmissions) ? count($latestSubmissions) . ' pengajuan terakhir' : 'Belum ada pengajuan' }}</p>
            </div>
        </div>
        @can('letter.view')
        ...
        <table class="table-enhanced">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-gray-700 text-sm capitalize">{{ $item['jenis_surat'] }}</td>
                    ...
                    <td class="text-gray-500 text-xs hidden lg:table-cell whitespace-nowrap">{{ $item['created_at'] }}</td>
                    <td class="text-center">
                        <a href="{{ $item['url'] }}" class="inline-flex items-center gap-1.5 text-emerald-600 hover:text-emerald-700 text-xs font-medium bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-lg border border-emerald-100 transition">
                            Detail
    ...
    <div class="px-5 py-12 text-center">
        ...
        <p class="text-sm text-gray-400 font-medium mt-3">Belum ada pengajuan surat</p>

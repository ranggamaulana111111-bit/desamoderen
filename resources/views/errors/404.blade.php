...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Prodesa</title>
...
<body class="bg-gray-50 font-sans antialiased min-h-screen flex items-center justify-center">
    <div class="text-center px-6 max-w-lg">
        <div class="text-8xl font-bold text-teal-600 mb-4">404</div>
        <h1 class="text-2xl font-semibold text-gray-800 mb-2">Halaman Tidak Ditemukan</h1>
        <p class="text-gray-500 mb-8">Halaman yang Anda cari mungkin telah dipindahkan, dihapus, atau URL yang dimasukkan salah.</p>

                    ...
                    <div class="lg:col-span-4 space-y-6">
                        <div class="widget-card lg:sticky lg:top-6 a-fade-up d2">
                            ...
                            <div class="widget-card-body space-y-4">
                                ...
                                {{-- Tips --}}
                                <div class="rounded-xl bg-teal-50 border border-teal-100 p-3.5 space-y-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <p class="text-xs font-semibold text-teal-700">Tips</p>
                                    </div>
                                    <ul class="space-y-1.5 text-[11px] text-teal-600 leading-relaxed">

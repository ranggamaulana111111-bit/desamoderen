        ...
        <div class="bento-card-static p-4 stat-micro">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl bg-teal-50 flex items-center justify-center">
                    <svg class="w-5 h-5 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <div>
                            ...
                            <td class="px-6 py-4">
                                @php
                                    $statusConfig = [
                                        ...
                                        'diproses' => ['bg-teal-50 text-teal-700 border-teal-100', 'bg-teal-500'],
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.surat-keluar.show', $item) }}"
                                        class="inline-flex items-center gap-1 text-teal-600 hover:text-white text-xs font-semibold bg-teal-50 hover:bg-teal-600 px-3 py-1.5 rounded-lg transition-all duration-200">

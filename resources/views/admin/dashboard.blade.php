<x-admin-layout title="Dashboard" maxWidth="max-w-[1600px]">
    @php
                    ...
                    >
                        ...
                        <template x-if="!loading && error">
                            <div class="bento-card bg-white rounded-2xl p-8 text-center">
                                ...
                                <button @click="retries = 0; error = false; load()" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-brand-500 to-teal-500 text-white text-sm font-semibold shadow-lg shadow-brand-500/25 hover:shadow-xl hover:shadow-brand-500/30 hover:-translate-y-0.5 transition-all duration-300">

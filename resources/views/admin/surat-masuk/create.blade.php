<x-admin-layout title="Tambah Surat Masuk" maxWidth="max-w-[1200px]">

    <div x-data="{
        tanggalTerima: '{{ old('tanggal_terima', date('Y-m-d')) }}',
                    ...
                    <div class="widget-card">
                        ...
                        <div class="widget-card-body space-y-5">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-gray-400 mt-1">Nomor agenda digenerate otomatis oleh sistem.</p>
                            </div>
                        ...
                        <div class="widget-card-body">
                            <div class="rounded-xl border border-gray-100 bg-gradient-to-br from-gray-50 to-white p-4 space-y-3">
                                <div class="flex items-center gap-2 flex-wrap">
                                    <span class="font-mono text-[10px] font-semibold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md">{{ $nomorAgenda }}</span>

<x-admin-layout title="Edit Event" maxWidth="max-w-[1200px]">
    ...
    <div x-data="{
        ...
        get jenisColor() {
            return { 'musrenbangdes': 'bg-purple-100 text-purple-700', 'rapat': 'bg-green-100 text-green-700', 'kegiatan': 'bg-blue-100 text-blue-700', 'sosialisasi': 'bg-amber-100 text-amber-700' }[this.jenis] || 'bg-purple-100 text-purple-700';
        },

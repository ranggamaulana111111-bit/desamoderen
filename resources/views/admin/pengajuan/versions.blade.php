                                    ...
                                    <td class="px-5 md:px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-1">
                                            <a href="{{ route('admin.pengajuan.versions.show', [$pengajuan, $version->version_number]) }}"
                                                class="inline-flex items-center gap-1 text-indigo-600 hover:text-indigo-700 text-xs font-semibold bg-indigo-50 hover:bg-indigo-100 px-2.5 py-1.5 rounded-lg transition">

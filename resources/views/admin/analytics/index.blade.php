    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
        <div class="stat-micro bg-white rounded-2xl border border-gray-200/60 p-4 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-extrabold text-gray-900">{{ $stats['overview']['total'] }}</p>
        ...
        <div class="stat-micro bg-white rounded-2xl border border-gray-200/60 p-4 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-extrabold text-gray-900">{{ $stats['overview']['completed'] }}</p>
        ...
        <div class="stat-micro bg-white rounded-2xl border border-gray-200/60 p-4 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-extrabold text-gray-900">{{ $stats['overview']['rejected'] }}</p>
        ...
        <div class="stat-micro bg-white rounded-2xl border border-gray-200/60 p-4 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-extrabold text-gray-900">{{ $stats['overview']['active'] }}</p>
        ...
        <div class="stat-micro bg-white rounded-2xl border border-gray-200/60 p-4 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-extrabold text-gray-900">{{ $stats['overview']['approvalRate'] }}%</p>
        ...
        <div class="stat-micro bg-white rounded-2xl border border-gray-200/60 p-4 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-extrabold text-gray-900">{{ $stats['overview']['rejectionRate'] }}%</p>
                    <p class="text-[10px] text-gray-500 font-medium">% Ditolak</p>
                </div>
            </div>
        </div>

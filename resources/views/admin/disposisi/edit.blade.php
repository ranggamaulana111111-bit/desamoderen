<x-admin-layout title="Edit Disposisi" maxWidth="max-w-[1200px]">
    <form method="POST" action="{{ route('admin.disposisi.update', $disposisi) }}">
        @csrf
        @method('PUT')
                    ...
                    <div class="widget-card-body space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="isi_disposisi" rows="4" required
                                ...
                                class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">{{ old('isi_disposisi', $disposisi->isi_disposisi) }}</textarea>
                            @error('isi_disposisi')
                                <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><circle cx="10" cy="10" r="8"/><text x="10" y="13.5" text-anchor="middle" fill="white" font-size="11" font-weight="bold">!</text></svg>
                                    {{ $message }}
                ...
                <div class="widget-card">
                    ...
                    <div class="widget-card-body space-y-5">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="sifat_disposisi" value="{{ old('sifat_disposisi', $disposisi->sifat_disposisi) }}">
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3" x-data="{ sifat: '{{ old('sifat_disposisi', $disposisi->sifat_disposisi) }}' }">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="deadline"
                                value="{{ old('deadline', \Carbon\Carbon::parse($disposisi->deadline)->format('Y-m-d\TH:i')) }}" required
                                class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">
                            @error('deadline')
                                <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><circle cx="10" cy="10" r="8"/><text x="10" y="13.5" text-anchor="middle" fill="white" font-size="11" font-weight="bold">!</text></svg>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="widget-card lg:sticky lg:top-6">
                    ...
                    <div class="widget-card-body">
                        <div x-data="{ status: '{{ old('status', $disposisi->status) }}' }">

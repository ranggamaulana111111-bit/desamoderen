...
<head>
    ...
    <title>Edit Role: {{ $role->name }} - Prodesa</title>
    ...
    <main class="flex-1 overflow-y-auto pt-16 md:pt-0">
        <div class="p-4 md:p-8 max-w-4xl">
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Edit Role: {{ $role->name }}</h1>
                    <p class="text-gray-500 mt-1 text-sm">Perbarui nama role dan permission-nya.</p>
                </div>

<form x-show="activeTab === 'tampilan'" x-cloak
    ...
    @csrf
    <div class="rounded-2xl border border-cyan-200 bg-cyan-50 p-4 mb-5">
        <div class="flex items-start gap-3">
            <svg class="w-5 h-5 text-cyan-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"/></svg>
            <p class="text-sm text-cyan-700">Warna aksen, dark mode, dan style sidebar berlaku sebagai <strong>tampilan default</strong> untuk seluruh pengguna. Setiap pengguna tetap dapat memilih preferensi pribadinya di menu tema sidebar.</p>
        </div>
    </div>
